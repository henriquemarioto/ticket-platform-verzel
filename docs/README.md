...
| **Filtros Avançados Multicritério** | Busca combinada por categoria, faixa de preço, intervalo de datas e cidade. | ✅ **Especificado** | [`05-ANALYTICS-AND-ADVANCED.md`](./01-use-cases/05-ANALYTICS-AND-ADVANCED.md#uc25) |
| **Dashboard do Organizador** | Painel com KPIs financeiros, faturamento em tempo real e taxa de ocupação. | ✅ **Especificado** | [`05-ANALYTICS-AND-ADVANCED.md`](./01-use-cases/05-ANALYTICS-AND-ADVANCED.md#uc26) |
...
- ❌ Revenda de ingressos (*marketplace peer-to-peer* secundário) entre usuários.
- ❌ Aplicativo nativo para smartphones (iOS / Android nativos) — *o web app é responsivo e mobile-first*.
